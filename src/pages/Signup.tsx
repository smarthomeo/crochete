      ...
      <main className="flex-grow mt-16 sm:mt-24">
        <div className="max-w-md mx-auto px-4 sm:px-6 py-12">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-serif font-medium text-espresso">Create an Account</h1>
            <p className="text-taupe mt-2">Join our community of crochet enthusiasts</p>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-lg card-shadow">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="fullName" className="block text-sm font-medium text-espresso">
                  Full Name
                </label>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-taupe">
                ...
                <Link to="/login" className="font-medium text-clay hover:text-espresso button-transition">
                  Sign in
                </Link>
              </p>
            </div>
